...
public class SecurityUser extends User implements OAuth2User {
	...
	public SecurityUser(String id, String username, String password, String nickname, Role role,
	...
	public SecurityUser(com.NBE_4_5_2.Team5.domain.user.user.entity.User user) {
		this(user.getId(), user.getUsername(), user.getPassword(), user.getNickname(), user.getRole(),
			user.getAuthorities());
	}
